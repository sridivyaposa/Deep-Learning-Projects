...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print(y.shape,final_outputs.shape)
        ...
        #print("hidden_outputs",hidden_outputs[:,None].shape)
        #a = hidden_outputs[:,None] * (1-hidden_outputs[:,None])
        #print("transpose",a.shape)
        hidden_error_term = self.weights_hidden_to_output * output_error_term * hidden_outputs[:,None] * (1-hidden_outputs[:,None])
        #print("hidden_error_term",hidden_error_term.shape)
        
        # Weight step (input to hidden)
        delta_weights_i_h += np.transpose(self.lr * hidden_error_term * np.transpose(X))
